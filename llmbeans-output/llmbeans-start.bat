...
./llama-cli -m /Users/<user>/.lmstudio/models/mlx-community/gemma-4-e4b-it-OptiQ-4bit -ngl 0 -c 4096 -t 8 -b 512 -tb 8 -ctk q8_0 -ctv q8_0 -fa --temp 0.7 --repeat-penalty 1.1 --logit-bias
